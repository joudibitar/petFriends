...
class AddPetScreenState extends State<AddPetScreen> {
  ...
  final _ownerNameController = TextEditingController(); // Add this controller
  String? _petType;
  String? _breed;
  String? _sex;
  String? _place;
  ...
  void initState() {
    ...
    if (widget.editPet != null) {
      ...
      _ownerNameController.text = widget.editPet!.ownerName; // Add this line
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        Pet newPet = Pet(
          ...
          ownerName: _ownerNameController.text, // Add this line
        );
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Sahibin Adı'), // Add this field
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Sahibin adı gerekli';
                  }
                  return null;
                },
              ),
